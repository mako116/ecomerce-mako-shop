...
export const Navbar = () => {
  ...
  return (
    <nav className=''>
        ...
        <NavLink to={"/womens"} className={({isActive})=> isActive ? "text-orange-400 relative flex-1 after:w-full after:h-[1px] after:bg-orange-400 after:absolute after:-bottom-0  after:right-0" : ""}><div className="flex items-center gap-x-1 pb-4"> <MdShop2 />women's</div></NavLink>
